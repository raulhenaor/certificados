...
<body>
    ...
    <div class="contenedorCurso">
        ...
        <img src="intranet/uploads/<?php echo $fila['LOGO']; ?>" alt="" width="400" height="180" class="imagenLogo" />
            <div class="tituloCurso">
            <h1>Consulta de Certificados</h1>
            </div>
                   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">        
                           
                       <div class="formularioTamaño">
                           <div class="mb-3">
                           <label for="exampleInputEmail1" class="form-label">Ingrese el Número de Identificación</label>
                           <input type="number" class="form-control" name="buscarPasajero" id="buscarPasajero" aria-describedby="emailHelp">
...
if(empty($_POST['buscarPasajero'])){
    echo '<div class="alert alert-danger alert-dismissible fade show formularioTamaño" role="alert">';
      ...
      <table class="table table-striped table-hover">
          ...
          <tbody>
              ...
              <tr class="">
                  ...
                  <td class="celEstado"><?php echo $fila['F_INCIAL']?></td>
...
<?php
    ...
    echo '<div class="alert alert-success alert-dismissible fade show formularioTamaño" role="alert">';
